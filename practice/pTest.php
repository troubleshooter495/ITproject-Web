...
?>
	...
	function normalized(nota){
		opa = {'m2':'Малая секунда','b2':'Большая секунда','m3':'Малая терция','b3':'Большая терция','c4':'Чистая кварта','c5':'Чистая квинта','m6':'Малая секста','b6':'Большая секста','m7':'Малая септима','b7':'Большая септима','c8':'Октава'};
		return opa[nota];
	}
