...
task=['Kакой интервал между первой и второй нотой в мажорном трезвучии?','Kакой интервал между первой и второй нотой в минорном трезвучии?','Какой интервал между второй и третьей нотой в мажорном секстаккорде?','Какой интервал между первой и третьей нотой в минорном квартсекстаккорде?','На каких ступенях строится доминантсептаккорд?','От какой ступени строится терцквартаккорд?', 'От какой ступени строится секундаккорд?'];
		f1 = [["узтзі'щмчэпі", false],["узтзі'щмчэпі", true],["узтзі'щмчэпі", false],["юпшщзі'сйпфщз", false],["<4>484:", false],["9", true],["9", false]];
		f2 = [["ихтѓязі'щмчэпі", true],["ихтѓязі'щмчэпі", false],["ихтѓязі'щмчэпі", false],["узтзі'шмсшщз", true],[":4<4>4@", false],[";", false],[";", true]];
		f3 = [["юпшщзі'сйзчщз", false],["юпшщзі'сйзчщз", false],["юпшщзі'сйзчщз", true],["ихтѓязі'шмсшщз", false],["<4>494;", true],["<", false],["<", false]];
		f4 = [["щчпщхф", false],["щчпщхф", false],["юпшщзі'сйпфщз", false],["узтзі'шмцщпуз", false],[">494;4<", false],[">", false],[">", false]];
		fields = [f1,f2,f3,f4]
		index = 0;
		rewrite();
		correctans = 0;
