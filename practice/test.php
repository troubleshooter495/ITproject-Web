...
<div class="midBlock">
	...
	<div class="testBlock">
		...
		<div class="replayButton1"><p id="opa">проиграть</p></div>
	</div>
	<div class="pianoBlock">
		...
		<div class="replayButton2"><p id="opa">проиграть</p></div>
	</div>
	<div class="chordBlock">
		...
		<div class="replayButton3"><p id="opa">проиграть</p></div>
	</div>
		...
		ansispressed = true;
			...
			$('.replayButton1').click(function(){
					if(ansispressed || currtry < amtr-1){
						...
						currpair[0].play(); currpair[1].play();
						outwrite('Повторов звука осталось: '+(amtr-currtry-1));
						currtry++;
						ansispressed = false;
					} else if(currtry==amtr-1) {
