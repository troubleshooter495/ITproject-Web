...
task=["<img src='img/1.jpg'>","<img src='img/2.jpg'>","<img src='img/3.jpg'>","<img src='img/4.jpg'>","<img src='img/5.jpg'>","Что делает знак диез (#)?","Что делает знак дубль-бемоль(♭♭)?","Какое расстояние от ноты <i>до</i> до <i>ре</i>?","Какая нота находится на расстоянии 3 тона и полутон от ноты <i>ми</i> вверх?","Какая нота находится на расстоянии 2 тона и полутон от ноты <i>фа#</i> вниз?"]
		f1 =[["Ті", false],["Лх", true],["Лх", false],["Ыз", false],["Уп", false],["Цхйђязмщ'фз'щхф", false],["Цхйђязмщ'фз'щхф", false],["Щхф", true],["Ті", false],["Уп", false],];
		f2 = [["Шхтѓ", true],["Чм", false],["Ті", false],["Уп", false],["Чм", true],["Цхйђязмщ'фз'цхтъщхф", true],["Цхйђязмщ'фз'цхтъщхф", false],["Цхтъщхф", false],["Ті*", false],["Лх", false]];
		f3 = [["Ыз", false],["Шп", false],["Шхтѓ", false],["Шхтѓ", false],["Ті", false],["Цхфпнзмщ'фз'щхф", false],["Цхфпнзмщ'фз'щхф", true],["Лйз'щхфз", false],["Шп", true],["Чм", false]];
		f4 = [["Ті*", false],["Уп", false],["Шп", true],["Ті", true],["Лх", false],["Цхфпнзмщ'фз'цхтъщхф", false],["Цхфпнзмщ'фз'цхтъщхф", false],["Щхф'п'цхтъщхф", false],["Лх", false],["Лх*", true]];
		fields = [f1,f2,f3,f4]
		index = 0;
		rewrite();
		correctans = 0;
